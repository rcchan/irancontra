...
<div style="margin: 0px 0px 0px 20px">
  <ul>
    <li>What interests weigh in the favor of preemptive pardons and what interests weigh against them? When, if ever, are preemptive pardons appropriate?</li>
  </ul>
  <ul>
    <li>Did President Bush abuse the pardon power in the Iran-Contra pardons? How strong were the justifications offered in the <a href="thepardons.php" class="content_link"> pardon statement</a>? </li>
  </ul>
  <ul>
    <li>Should the U.S. Constitution be amended in some way to limit or balance the pardon power?</li>
  </ul>
</div>
